export const TeamBadge = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
    ...
    >
      ...
      <path
        ...
        stroke="url(#paint1_linear_72_611)"
        strokeWidth="2"
      />
      <rect
        x="14"
      ...
      <path
        ...
        fill="url(#paint3_linear_72_611)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_72_611"
          x1="24"
          y1="0.5"
          x2="24"
          y2="48.5"
